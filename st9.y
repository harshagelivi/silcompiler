...
%token INT PLUS PDT NL MINUS DIV ID STMT DELIM ASGN READ WRITE ENDIF IF THEN ELSE WHILE ENDWHILE DO BOOL VOID LT LE GT GE EQ NEQ SLIST CTRUE CFALSE DECL ENDDECL COMMA PBEGIN PEND NUM ABOOL AMPD
...
%%
start: declarations fdlist PBEGIN slist PEND		{return 0;}
		;
